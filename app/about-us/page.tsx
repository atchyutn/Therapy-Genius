...
const AboutUs = () => (
  <>
    <Navbar />
    <div className="bg-gradient-to-r from-violet-200 to-pink-200 overflow-hidden shadow-lg px-20 py-5">
      <div className="container mx-auto px-10 justify-center py-16 max-w-7xl">
        ...
        <p className="text-lg font-semibold text-gray-700 mb-8">
          ...
          journey began with a conversation I had with a close friend, a
          dedicated therapist who runs a therapy center.
        </p>
        <p className="text-lg font-semibold text-gray-700 mb-8">
          ...
          tailored to the child&apos;s unique condition, goals, and therapy
          type. The process was time-consuming and riddled with potential for
          grammatical errors, inconsistencies, and inefficiencies. These issues
          not only created extra work but also detracted from the time that
          could be spent focusing on the children&apos;s needs.
        </p>
        <p className="text-lg font-semibold text-gray-700 mb-8">
          Inspired by these pain points and fueled by my commitment to making a
          difference, I decided to take action. As part of Hashnode&apos;s
          &apos;AI for Tomorrow&apos; Hackathon, I embarked on a mission to
          create a solution that would streamline this process and enhance the
          quality of therapy. Using data from previous reports, we developed an
          AI-powered system capable of generating personalized therapy
          activities. This innovative solution considers factors such as age,
          gender, condition, and therapy type to create engaging and effective
        ...
        <p className="text-lg font-semibold text-gray-700 mb-8">
          ...
          focusing on the unique needs of each child, we aim to make therapy
          more effective and enjoyable, ultimately helping children reach their
          full potential.
        </p>
        <p className="text-lg font-semibold text-gray-700">
          We are proud of the impact our solution is making in the field of
          therapy and excited to continue evolving and improving our offerings
          to better support therapists and the children they care for.
        </p>
